...
namespace renderer
{
    MaxProcTextureSource::MaxProcTextureSource(
    ...
    //--- Shade Context
    class MaxProcTextureSource::MaxSC
        :public ShadeContext {
        ...
        const foundation::Vector2f&         uv) const
    {
        ...
        //return foundation::Color4f(maxsc.out.c.r, maxsc.out.c.g, maxsc.out.c.b, 1.0f);
